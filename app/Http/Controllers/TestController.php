...
//        $data=request()->post();
    ...
    public function alipay(){
        ...
        //公共参数
        $public=[
            'app_id'    =>'2016102300743127',
            'method'    =>'alipay.trade.page.pay',
            'format'    =>'JSON',
            'return_url'=>'http://1911api.yisirdisco.cn/alipay/return',//同步通知
            'charset'   =>'utf-8',
            'sign_type' =>'RSA2',
            'timestamp' =>date('Y-m-d H:i:s'),
            'version'   =>'1.0',
            'notify_url'=>'http://1911api.yisirdisco.cn/alipay/notify',//异步通知
    ...
    protected function signs($data)
    {
//        if ($this->checkEmpty($this->rsaPrivateKeyFilePath)) {
//            $priKey = $this->rsaPrivateKey;
//
        $priKey = file_get_contents(storage_path('key/alipay_privkey.php'));
